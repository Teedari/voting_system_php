<?php include("admin/includes/init.php")?>
  ...
  $email = $database->escape_string($_POST['email']);
   ...
   $success = Voter::insert_voters($number, $index, $email);
    if($success){ 
      if(User::insert_user($index, $number, 0)){
            $session->login_user( $index, $number);
      }
...
<head>
  ...
  <title>UENR VOTING SYSTEM- Register</title>
...
<nav class="navbar navbar-expand-lg navbar-white bg-white shadow">
    ...
    <div class="row">
        <div class="col-lg-4 col-md-6 m-auto">
            <div class="py-5 px-5 shadow">
                ...
                <h2 class="my-4 text-primary">Voter Registration</h2>
                 <form action="" method="post" class="form">
                   ...
                   <div class="form-group">
                       <button id="btnHide" type="submit" name="register_user" class="btn btn-secondary px-5">Sign up</button>
                   </div>
               </form>
  ...
  <script src="admin/vendor/jquery-easing/jquery.easing.min.js"></script>
    <script src="admin/js/my-script/voter.js">
</body>
</html>